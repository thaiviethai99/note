			...
			return (
		        ...
		        <div className="timeline-panel">
		            ...
		            <div className="timeline-body">
		                <p><textarea className="style-1" cols="50" ref="txtContent" className="ckeditor" name="edit_description"  onChange={this.loadCk} id={this.props.id}>{children}</textarea></p>
		            </div>
	...
	render(){
		...
		return (
			...
			<div className="form-group">
			  ...
			  <div className="col-md-4">
			    <textarea className="form-control" ref="txtInsertDescription" id="description" name="description"></textarea>
			  </div>
			...
			<div className="form-group">
			  ...
			  <div className="col-md-4">
			      <label className="radio-inline">
				      <input type="radio" name="optradio" onClick={this.setGender} defaultChecked="true" ref="txtInsertPos" value="left" />Option 1
				    </label>
				    <label className="radio-inline">
				      <input type="radio" name="optradio" onClick={this.setGender} ref="txtInsertPos" value="right"/>Option 2
				    </label>
			  </div>
			</div>
			<div className="form-group">
